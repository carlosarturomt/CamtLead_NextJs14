            ...
            <article className='rounded-md w-full py-8 px-4 flex flex-col justify-center items-center bg-whiteAlternative dark:bg-blueAlternative'>
              ...
              <form onSubmit={submitHandler} className="w-full">
                ...
                <div className='w-full flex items-center justify-between'>
                  {/* First Name */}
                  <div className='mt-2 sm:w-[49.666%]'>
                    <input
                      required
                ...
                <div className='w-full flex items-center justify-between'>
                  {/* Degree */}
                  <div className='sm:w-[32.666%] mt-2'>
                    <select
                      required
                      className={`focus:outline-none w-full border-[1px] border-midnight no-focus py-[10px] p-2 rounded-md text-blueLight`}
                      id="degree" type="degree" name="degree">
                      <option value="" className='hidden'>Título</option>
                ...
                <div className='w-full flex items-center justify-between'>
                  ...
                  <div className='sm:w-[32.666%] mt-2'>
                    <select
                      ...
                      <option value="" className='hidden'>País</option>
                  ...
                  <div className='sm:w-[32.666%] mt-2'>
                    <input
                      ...
                      className={` focus:outline-none w-full border-[1px] border-midnight no-focus p-2 rounded-md text-blueLight`}
                ...
                <div className='w-full flex items-center justify-between'>
                  ...
                  {/* Password */}
                  <div className='mt-2 sm:w-[49.666%] relative flex items-center'>
                    <input
                      required
                      placeholder="Contraseña:"
